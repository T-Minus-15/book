...
[cols="<1,<3"]
|===
| **Objective** | Validate the functionality, usability, and performance of the currently delivered features

| **Prerequisites** | Confirm end users have the required access

| **Frequency** | As needed (typically at end of sprint or major releases)

| **Duration** | 2-3 hours

| **Attendees** | **Required:** Tester, Tech Lead, End Users +
**Optional:** Development team members for issue resolution

| **Agenda** | Overview of the test strategy (by Tester), including:

• Testing schedule
• Scope

Demo the solution (Tech Lead)

Testing dashboard (Tester)

How to test (Tester)

How to report a bug (Tester)

Testing (End Users)

_All software has bugs, our objective here is to find them all_
|===