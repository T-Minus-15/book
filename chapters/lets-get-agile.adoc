...
For the full breakdown of what each state means, including entry and exit criteria, see <<appendix-states>>. That's where we spell out exactly what "Design" means for a Feature versus what "Validation" means for an Epic (hint: they're very different beasts).
