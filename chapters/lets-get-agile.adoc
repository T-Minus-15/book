...
Think of states as your mission control dashboard – they tell you exactly where every piece of work sits on its journey from idea to impact. Without clear states, you're flying blind, and trust me, that's not how successful launches happen.
...
|**Epics** (SAFe)
|New → Validation → Funnel → Proposing → Pending → Schedule → Implementing → Operate → Done (or On-hold/Removed)
...
For the full breakdown of what each state means, including entry and exit criteria, see <<appendix-states>>. That's where we spell out exactly what "Design" means for a Feature versus what "Validation" means for an Epic. Spoiler alert: they're very different beasts.
