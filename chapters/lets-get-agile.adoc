...
.Kanban Board with WIP Limits - 2 Engineers Team Example
|===
|New |Prep (2) |Engineering (4) |Testing (2) |Done
...
*WIP Limits shown in parentheses (WIP Limit)*

Notice how:
- The Engineering column is at capacity (4/4) - no new features can enter until one moves to Testing
- Testing is also at capacity (2/2) - creates a bottleneck
- This forces the team to collaborate: engineers must help with testing or code reviews rather than starting new work
